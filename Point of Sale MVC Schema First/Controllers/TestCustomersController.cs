...
{
    public class TestCustomersController : Controller
    {
        ...
        // GET: TestCustomers/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TestCustomers/Create
